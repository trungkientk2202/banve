						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<div  style="padding-bottom: 32px;text-align: center;">
									<img  src="data:image/png;base64,${ct.base64Image}" width="500" height="500" >
								...
								<div style="padding-bottom: 32px;text-align: center;">
									<span>Birthday: </span>
									<span>${ct.ngaySinh}</span>
								</div>
								<div  style="padding-bottom: 32px;text-align: center;">
									<span>National: </span>
									<span>${ct.noiSinh}</span>
								</div>
								<div style="padding-bottom: 32px;text-align: center;">
									<span>Weight (kg): </span>
									<span>${ct.canNang}</span>
								</div>
								<div style="padding-bottom: 32px;text-align: center;">
									<span>Height (cm): </span>
									<span>${ct.chieuCao}</span>
								</div>
