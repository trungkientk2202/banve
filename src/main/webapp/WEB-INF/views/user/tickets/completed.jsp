				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default" style="padding: 12px 32px;">
							<div class="panel-heading" style="font-size: 16px;color: blue;">Successful ticket purchase</div>
							<div class="panel-body">
								<div>
									<div style="display: flex;">
										...
										<div>
											<div style="line-height: 150px">
												<img height="90" width="90" src="data:image/png;base64,${hoaDon.tranDau_Ve.tranDau.thamGiaGiai.doiBong.base64Image}"/>
											</div>
											<div style="text-align: center;">${hoaDon.tranDau_Ve.tranDau.thamGiaGiai.doiBong.tenDoi}</div>
												
										</div>
									</div>
									<h4>Ngày thi đấu: ${hoaDon.tranDau_Ve.tranDau.ngayThiDau}</h4>
									<h4>Thời gian thi đấu: ${hoaDon.tranDau_Ve.tranDau.thoiGianBD}</h4>
									<h3>Số lượng vé mua: ${hoaDon.soLuongMua}</h3>
								</div>
								...
								<span>Thông tin vé đã được gửi về email của bạn!</span>
								<br>
