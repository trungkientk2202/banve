									...
									<tbody >
										<c:forEach items="${tranDau}" var="list">
											<tr class="odd gradeX text-center " >
												...
												<td>${list.nhaKhach==1?'Nou camp stadium':list.thamGiaGiai.doiBong.sanNhaCLB}</td>
												<td>${list.nhaKhach==0?list.thamGiaGiai.doiBong.tenDoi:'Barcelona'} ${list.btDoiNha}-${list.btDoiKhach} ${list.nhaKhach==1?list.thamGiaGiai.doiBong.tenDoi:'Barcelona'}</td>
											</tr>
										</c:forEach>
